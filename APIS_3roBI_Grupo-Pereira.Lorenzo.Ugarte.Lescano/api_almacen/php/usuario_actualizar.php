<?php
	...
	$check_usuario=$check_usuario->query("SELECT * FROM user WHERE usuario_id='$id'");
    ...
    $check_admin=$check_admin->query("SELECT usuario_usuario,usuario_clave FROM user WHERE usuario_usuario='$admin_usuario' AND usuario_id='".$_SESSION['id']."'");
    ...
    $actualizar_usuario=$actualizar_usuario->prepare("UPDATE user SET usuario_nombre=:nombre,usuario_apellido=:apellido,usuario_usuario=:usuario,usuario_clave=:clave,usuario_email=:email WHERE usuario_id=:id");
