<?php
    ...
    $check_usuario=$check_usuario->query("SELECT usuario_id FROM user WHERE usuario_id='$user_id_del'");
    ...
    if($check_usuario->rowCount()==1){
    	...
    	if($check_productos->rowCount()<=0){
	    	...
	    	$eliminar_usuario=$eliminar_usuario->prepare("DELETE FROM user WHERE usuario_id=:id");
