<?php
	...
	if(isset($busqueda) && $busqueda!=""){
		...
		$consulta_datos="SELECT $campos FROM productos INNER JOIN categoria ON productos.categoria_id=categoria.categoria_id INNER JOIN user ON productos.usuario_id=user.usuario_id WHERE productos.categoria_id='$categoria_id' ORDER BY productos.producto_nombre ASC LIMIT $inicio,$registros";

		$consulta_total="SELECT COUNT(producto_id) FROM productos WHERE categoria_id='$categoria_id'";

	}else{

		$consulta_datos="SELECT $campos FROM productos INNER JOIN categoria ON productos.categoria_id=categoria.categoria_id INNER JOIN user ON productos.usuario_id=user.usuario_id ORDER BY productos.producto_nombre ASC LIMIT $inicio,$registros";
			        ...
			        <div class="media-content">
			            <div class="content">
			              <p>
			                ...
			                <strong>CODIGO:</strong> '.$rows['producto_codigo'].', <strong>PRECIO:</strong> $'.$rows['producto_precio'].', <strong>STOCK:</strong> '.$rows['producto_stock'].', <strong>LOTE:</strong> '.$rows['categoria_nombre'].', <strong>REGISTRADO POR:</strong> '.$rows['usuario_nombre'].' '.$rows['usuario_apellido'].'
			              </p>
			            </div>
